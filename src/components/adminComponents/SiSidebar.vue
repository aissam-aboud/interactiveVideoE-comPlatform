...
export default {
    ...
    methods: {
        getComponentName(componentName, componentDraggClass) {
            ...
            document.getElementsByClassName(`${componentDraggClass}-li`)[0].style.backgroundColor = '#6bb8fd';
