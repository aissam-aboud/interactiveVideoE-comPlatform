<template>
    <div class="container">
        ...
        <video ref="siVideo" class="siVideo" controls autoplay muted @timeupdate="getCurrentTime()" @ended="onEnd()">
            <source src="../assets/myVideoo.mp4" type="video/mp4" >
        </video>
...
import SiMoveTo from './../components/SiMoveTo';
        ...
        return {
            ...
            elements: [
                ...
                },
                {
                    ...
                    currentProps: {
                        text: 'Arrière : 12 MP f/1.8 + 12 MP f/2.4 | Avant : 7 MP f/2.2Arri2 MP f/2.4 | Avant : 7 MP f/2.2Arrière : 12 MP f/1.8 + 12 MP f/2.4 | Avant : 7 MP f/2.2',
